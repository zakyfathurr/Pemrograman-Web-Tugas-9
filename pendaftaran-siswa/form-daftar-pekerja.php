...
<body>
    <form action="proses-pendaftaran-pekerja.php" method="POST">

    <a href="index.php" class="back-button">←← Back</a>
    <p class="text-center"><b>Formulir Pendaftaran Pekerja</b></p>
    ...
    <br>
    Posisi : <td> <input type="text" name="posisi"  required></td>
    <br>
    No Telp : 
    <input type="text" name="phone" maxlength="16" size="16"/ required> 
    <p>Email : <input type="email" name="email" value="YourEmail@gmail.com" placeholder required </p <br>
